...
<body class="skin-black">
	...
	<header class="header"> <a class="logo"> 装备智能化管理 </a> <!-- Header Navbar: style can be found in header.less -->
		...
		<ul class="nav navbar-nav">
						...
						<ul class="menu">
							<li>
								<!-- start message --> <a>
									...
									<h4>一级民警杨传君</h4>
									<p>申请：一根警棍</p> <small
									class="pull-right"><i class="fa fa-clock-o"></i> 6分钟前</small>
							</a>
							</li>
							<li>
								<!-- start message --> <a>
									...
									<h4>一级民警10001</h4>
									<p>高端装备申请：探测仪</p> <small
									class="pull-right"><i class="fa fa-clock-o"></i> 28分钟前</small>
							</a>
							</li>
							<!-- end message -->
						</ul>
					</li>
					<li class="footer"><a>查看所有消息</a></li>
				</ul></li>
			<!--任务信息---------------------------------->
			<!----------=略=-------->
			<!--用户信息------------------------------>
			...
			<li class="dropdown user user-menu"><a class="dropdown-toggle"
				...
				<ul class="dropdown-menu dropdown-custom dropdown-menu-right">
					...
					<li class="divider"></li>
					<li>
						<!-- 判断是否为管理员 --> <s:if test="#session.role=='大队管理员'">
		...
		<s:if test="#session.role=='系统管理员'">
			...
			<ul class="sidebar-menu">
				<li><a href="#sub1" data-toggle="collapse" class="collapsed"
					aria-expanded="false"> <i class="fa fa-user"></i> <span>装备管理</span>
						<i class="icon-submenu fa fa-angle-left"></i>
				</a>
					<div id="sub1" class="collapse" aria-expanded="false"
						style="height: 0px;">
						<ul class="nav">
							<li><a class="">装备申请管理</a></li>
							<li><a class="">已借出装备</a></li>
						</ul>
					</div></li>
			</ul>
			<ul class="sidebar-menu">
				<li><a href="#sub2" data-toggle="collapse" class="collapsed"
					aria-expanded="false"> <i class="fa fa-user"></i> <span>车辆管理</span>
						<i class="icon-submenu fa fa-angle-left"></i>
				</a>
					<div id="sub2" class="collapse" aria-expanded="false"
						style="height: 0px;">
						<ul class="nav">
							<li><a class="">车辆信息管理</a></li>
						</ul>
					</div></li>
			</ul>
		</s:if> <s:if test="#session.role=='大队管理员'">
			<ul class="sidebar-menu">
				<li><a href="#sub1" data-toggle="collapse" class="collapsed"
					aria-expanded="false"> <i class="fa fa-user"></i> <span>装备管理</span>
						<i class="icon-submenu fa fa-angle-left"></i>
						...
						<div id="info_display">
							<div class="panel-body">
								<div class="tab-content">
									<div id="info_content">
										<div class="top_line">
											<h4 class="h4_style">首页</h4>
											<div  id="gonggao"> 
<div  id="gonggaoTitle">公告<a href="#" target="_self">更多>></a> </div>
<div  id="gonggaoBox">
    <ul>
        <li><a href="#">1.公告标题1</a><span>时间1</span></li>
        <li><a href="#">2.公告标题2</a><span>时间2</span></li>
        <li><a href="#">3.公告标题3</a><span>时间3</span></li>
...
<div  id ="moocBot"> </div>
	...
	<script type="text/javascript">
		...
		function toIntroductionModify() {
			$('.right-side').load('page/zb/IntroductionModify.jsp #content', function() {
				$.getScript("js/zb/IntroductionModify.js");
			});
		}
		function exit_alert() {
			$.confirm({
				...
				buttons : {
					deleteUser : {
						...
						text : '确定',
						action : function() {
							window.location.href = "/pxzb/System/system_exit"
						}
					},
					cancelAction : {
						btnClass : 'btn-blue',
		...
		$(window).unload(function(evt) {
			...
			if (evt) {
				...
				if (b && window.event.clientY < 0 || window.event.altKey) {
					tosstr.info('已退出登录');
					$.post('/pxzb/System/system_exit', {}, function(xhr) {}, 'json');
				}
			}
		});
	</script>
