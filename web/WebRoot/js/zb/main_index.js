...
var info_data = {
	...
	zbInfo : { //用户
		"zbInfo.userId" : "",
		"zbInfo.jobStatue" : "",
		"zbInfo.highestDegree" : "",
		"zbInfo.highestEducation" : "",
		"zbInfo.learnEdgeStructure" : "",
		"zbInfo.professionalTitle" : "",
		"zbInfo.subjectCategory" : "",
		"zbInfo.teachingProfessionName" : "",
		"zbInfo.professionTeachingDate" : "",
		"zbInfo.workDate" : "",
		"user.userName" : "",
	},
	zbPaper : { //论文
		"zbPaper.userId" : "",
		"zbPaper.paperName" : "",
		"zbPaper.authorUserNames" : "",
		"zbPaper.paperType" : "",
		"zbPaper.periodical" : "",
		"zbPaper.periodicalNo" : "",
	},
	zbPatent : { //专利
		"zbPatent.patentName" : "",
		"zbPatent.patentType" : "",
		"zbPatent.authorizationNo" : "",
	},
	zbProject : { //项目
		"zbProject.projectName" : "",
		"zbProject.projectSource" : "",
		"zbProject.projectUserNames" : "",
		"zbProject.projectType" : "",
	},
	zbWorks : { //著作
		"zbWorks.worksName" : "",
		"zbWorks.worksType" : "",
		"zbWorks.press" : "",
		"zbWorks.isbn" : "",
		"zbWorks.editorUserNames" : "",
		"zbWorks.selectedSituation" : "",
		"zbWorks.selectedDate" : "",
	},
	carInfo : { //学生模块模态框string赋空值
		"carInfo.car_id" : "",
		"carInfo.carName" : "",
		"carInfo.certificateNo" : "",
		"carInfo.classNumber" : "",
		"carInfo.className" : "",
		"carInfo.departmentId" : "",
		"carInfo.zbTraining" : "",
		"carInfo.deformed" : "",
	},
...
$(function() {
	$('.sidebar-menu .nav li a').click(function() {
		...
		case "装备申请管理": //管理员
			$('.right-side').load('page/zb/zb_information_audit.jsp #content', selectSeacher(), function() {
				data.dataState = "20";
				$.getScript("js/zb/zb_information_audit.js");
			});			break;
		case "已借出装备": //管理员
			$('.right-side').load('page/zb/zb_Information_management.jsp #content', selectSeacher(), function() {
				data.dataState = "40";
				$.getScript("js/zb/zb_Information_management.js");
			});			break;
		case "车辆信息管理": //管理员-学生
			$('.right-side').load('page/car/car_information_management.jsp #content', selectSeacher(), function() {
				data.dataState = "20";
				$.getScript("js/car/car_information_management.js");
			});			break;
		case "教师信息查看": //教师用户登录时使用
			$('.right-side').load('page/zb/user_Information_management.jsp #content', selectSeacher(), function() {
				$.getScript("js/zb/user_Information_management.js");
			})			break;
		default:
			break;
		}
...
function user_setting() {
	...
	$.confirm({
		...
		onContentReady : function() {
			$.post('/pxzb/System/system_getAccountInformation', {}, function(xhr_data) {
		...
		buttons : {
			deleteUser : {
				...
				text : '修改',
				action : function() {
					$.post('/pxzb/System/system_modifyUserInfo', $('#user_setting').serialize(), function(xhr_data) {
...
var ImgManiFunc = {
	...
	setImgDiv : function(pahtValue, userid) {
	   ...
	   <img effect="imgshow" src="/pxzb/System/system_Attachment?attachmentUserid=${userid}&attachmentName=${pahtValue}!${data.tableName}" alt="" class="img-show"></div>
	   <div class="info">
		   <div class="img-control-btn img-modify-btn" title="编辑">
...
function setImgDiv(pahtValue) {
   ...
   <div class="img">
     <img src="/pxzb/System/system_Attachment?attachmentName=${pahtValue}!${data.tableName}" alt="" class="img-show">
   </div>
		...
		if (option.hasClass('true') || pla == "") {
			...
			if ((con.indexOf("Date")) >= 0 || (con.indexOf("Time")) >= 0) {
				...
				$('.input_div button').click(function() {
					...
					//移除时候清空js中已存的数据
					if (con == "userName") {
						info_data["zbInfo"]["user.userName"] = "";
					} else {
						info_data[data.tableName][data.tableName.replace("T", "t") + "." + $(this).parent().val()] = "";
					}
					$(this).parent().remove();
