			...
			<form id="info_form">
				<div class="modal-content">
					...
					<div class="modal-body">
						<div id="main_body">
							<table class="tab com-table">
								<tr>
									<td>奖励名称:</td>
									<td><input name="zbAward.awardName"
										class="form-control table_infomation" type="text"></td>
									<td>获奖者姓名:</td>
									<td><input name="zbAward.awardUserNames"
										class="form-control table_infomation" type="text"></td>
								</tr>
								<tr>
									<td>获奖者工号_排名:</td>
									<td><input name="zbAward.awardUserIds"
										class="form-control table_infomation" type="text"></td>
									<td>奖励类型:</td>
									<td><select name="zbAward.awardType" draggable="true"
								...
								<tr>
									<td>获奖类别:</td>
									<td><select name="zbAward.awardClass"
										class="form-control table_infomation">
									...
									<td>获奖等级:</td>
									<td><select name="zbAward.awardGrade"
										class="form-control table_infomation">
											<option>特等奖</option>
											<option>一等奖</option>
											<option>二等奖</option>
								...
								<tr>
									<td>获奖级别:</td>
									<td><select name="zbAward.awardLevel"
										class="form-control table_infomation">
											<option>国家</option>
											<option>省级</option>
											<option>市级</option>
									...
									<td>获奖时间:</td>
									<td><input name="zbAward.awardDate"
										class="form-control table_infomation mydate" onfocus="time()"
										type="text"></td>
								</tr>
								<tr>
									<td>获奖证书编号:</td>
									<td><input name="zbAward.awardCertificationNo"
										class="form-control table_infomation" type="text"></td>
									<td>授予单位:</td>
									<td><input name="zbAward.grantUnit"
										class="form-control table_infomation" type="text"></td>
								</tr>
					...
					<div class="modal-footer">
						...
						<input name="zbAward.awardId" id="tableid" type="hidden" />
					</div>
				</div>
			</form>
			<!-- /.modal-content -->
