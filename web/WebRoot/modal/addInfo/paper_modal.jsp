			...
			<form id="info_form">
				<div class="modal-content">
					...
					<div class="modal-body">
						<div id="main_body">
							<table class="tab com-table">
								<tr>
									<td>论文名称:</td>
									<td><input name="zbPaper.paperName"
										class="form-control table_infomation" type="text"></td>
									<td>作者:</td>
									<td><input name="zbPaper.authorUserNames"
										class="form-control table_infomation" type="text"></td>
								</tr>
								<tr>
									<td>作者工号_排名:</td>
									<td><input name="zbPaper.authorUserIds"
										class="form-control table_infomation" type="text"></td>
									<td>论文类别:</td>
									<td><select name="zbPaper.paperType"
								...
								<tr>
									<td>发表期刊:</td>
									<td><input name="zbPaper.periodical"
										class="form-control table_infomation" type="text"></td>
									<td>期号:</td>
									<td><input name="zbPaper.periodicalNo"
										class="form-control table_infomation" type="text"></td>
								</tr>
								<tr>
									<td>发表日期:</td>
									<td><input name="zbPaper.publishTime"
										class="form-control  table_infomation laydate-icon"
										onfocus="time()" type="text"></td>
									<td>收录情况:</td>
									<td><select name="zbPaper.includedSituation"
										class="form-control table_infomation">
											<option>SCI</option>
											<option>SSCI</option>
											<option>EI</option>
								...
								<tr>
									<td>他引次数:</td>
									<td><input name="zbPaper.totalCitations"
										class="form-control table_infomation" type="text"></td>
									<td>与行业联合发表:</td>
									<td><select name="zbPaper.sfyhylhfb"
										class="form-control table_infomation">
											<option>否</option>
											<option>是</option>
									</select></td>
								...
								<tr>
									<td>与地方联合发表:</td>
									<td><select name="zbPaper.sfydflhfb"
										class="form-control table_infomation">
											<option>否</option>
											<option>是</option>
									</select></td>
									<td>与国际联合发表:</td>
									<td><select name="zbPaper.sfygjlhfb"
										class="form-control table_infomation">
											<option>否</option>
											<option>是</option>
									</select></td>
								...
								<tr>
									<td>跨学科论文:</td>
									<td><select name="zbPaper.sfskxklw"
										class="form-control table_infomation">
											<option>否</option>
											<option>是</option>
									</select></td>
									<td>成果字数:</td>
									<td><input name="zbPaper.wordsNum"
										class="form-control table_infomation" type="text"></td>
								</tr>
					...
					<div class="modal-footer">
						...
						<input name="zbPatent.patentId" id="tableid" type="hidden" />
