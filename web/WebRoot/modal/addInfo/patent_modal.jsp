					...
					<div class="modal-body">
						<div id="main_body">
							<table class="tab com-table">
								<tr>
									<td>专利名称:</td>
									<td><input name="zbPatent.patentName"
										class="form-control table_infomation" type="text"></td>
									<td>作者姓名:</td>
									<td><input name="zbPatent.authorUserNames"
										class="form-control table_infomation" type="text"></td>
								</tr>
								<tr>
									<td>作者工号_排名:</td>
									<td><input name="zbPatent.authorUserIds"
										class="form-control table_infomation" type="text"></td>
									<td>专利类型:</td>
									<td><input name="zbPatent.patentType"
										class="form-control table_infomation" type="text"></td>
								</tr>
								<tr>
									<td>授权号:</td>
									<td><input name="zbPatent.authorizationNo"
										class="form-control table_infomation" type="text"></td>
									<td>获批日期:</td>
									<td><input name="zbPatent.approvedDate"
										class="form-control table_infomation laydate-icon"
										onfocus="time()" type="text"></td>
								</tr>
								<tr>
									<td>是否应用:</td>
									<td><select name="zbPatent.isApplication"
										class="form-control table_infomation">
											<option>否</option>
											<option>是</option>
									</select></td>
									<td>行业联合专利(著作权):</td>
									<td><select name="zbPatent.sfhylh"
										class="form-control table_infomation">
											<option>否</option>
											<option>是</option>
									</select></td>
