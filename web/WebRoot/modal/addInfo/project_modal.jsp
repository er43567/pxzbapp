			...
			<form id="info_form">
				<div class="modal-content">
					...
					<div class="modal-body">
						<div id="main_body">
							<table class="tab com-table">
								<tr>
									<td>项目名称:</td>
									<td><input name="zbProject.projectName"
										class="form-control table_infomation" type="text"></td>
									<td>项目来源:</td>
									<td><select name="zbProject.projectSource"
								...
								<tr>
									<td>成员姓名:</td>
									<td><input name="zbProject.projectUserNames"
										class="form-control table_infomation" type="text"></td>
									<td>成员工号_排名:</td>
									<td><input name="zbProject.projectUserIds"
										class="form-control table_infomation" type="text"></td>
								</tr>
								<tr>
									<td>立项编号(批准文号):</td>
									<td><input name="zbProject.projectNo"
										class="form-control table_infomation" type="text"></td>
									<td>项目类别:</td>
									<td><input name="zbProject.projectType"
										class="form-control table_infomation" type="text"></td>
								</tr>
								<tr>
									<td>立项日期:</td>
									<td><input name="zbProject.approvalDate"
										class="form-control table_infomation laydate-icon"
										onfocus="time()" type="text"></td>
									<td>结题验收(鉴定日期):</td>
									<td><input name="zbProject.endUpDate"
										class="form-control table_infomation laydate-icon"
										onfocus="time()" type="text"></td>
								</tr>
								<tr>
									<td>经费:</td>
									<td><input name="zbProject.funds"
										class="form-control table_infomation" type="text"></td>
									<td>参与教师数:</td>
									<td><input name="zbProject.memberNum"
										class="form-control table_infomation" type="text"></td>
								</tr>
								<tr>
									<td>级别:</td>
									<td><select name="zbProject.level"
										class="form-control table_infomation">
											<option>国家级</option>
											<option>省部级</option>
									</select></td>
									<td>是否重点:</td>
									<td><select name="zbProject.isImportant"
										class="form-control table_infomation">
											<option>否</option>
											<option>是</option>
									</select></td>
					...
					<div class="modal-footer">
						...
						<input name="zbProject.projectId" id="tableid" type="hidden" />
