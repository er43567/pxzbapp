			...
			<form id="info_form">
				<div class="modal-content">
					...
					<div class="modal-body">
						<div id="main_body">
							<table class="tab com-table">
								<tr>
									<td>著作(专著)名称:</td>
									<td><input name="zbWorks.worksName"
										class="form-control table_infomation" type="text"></td>
									<td>著作类别:</td>
									<td><select name="zbWorks.worksType"
								...
								<tr>
									<td>出版社:</td>
									<td><input name="zbWorks.press"
										class="form-control table_infomation" type="text"></td>
									<td>ISBN:</td>
									<td><input name="zbWorks.isbn"
										class="form-control table_infomation" type="text"></td>
								</tr>
								<tr>
									<td>入选情况:</td>
									<td><select name="zbWorks.selectedSituation"
										class="form-control table_infomation">
									...
									<td>入选时间:</td>
									<td><input name="zbWorks.selectedDate"
										class="form-control  table_infomation mydate" onfocus="time()"
										type="text"></td>
								</tr>
								<tr>
									<td>主编(作者):</td>
									<td><input name="zbWorks.editorUserNames"
										class="form-control table_infomation" type="text"></td>
									<td>副主编:</td>
									<td><input name="zbWorks.subEditorUserNames"
										class="form-control table_infomation" type="text"></td>
								</tr>
								<tr>
									<td>主编工号_排名:</td>
									<td><input name="zbWorks.editorUserIds"
										class="form-control table_infomation" type="text"></td>
									<td>副主编工号_排名:</td>
									<td><input name="zbWorks.subEditorUserIds"
										class="form-control table_infomation" type="text"></td>
								</tr>
								<tr>
									<td>参编:</td>
									<td><input name="zbWorks.associateEditorUserNames"
										class="form-control table_infomation" type="text"></td>
									<td>出版时间:</td>
									<td><input name="zbWorks.publishTime"
										class="form-control  table_infomation mydate" onfocus="time()"
										type="text"></td>
								</tr>
								<tr>
									<td>参编工号_排名:</td>
									<td><input name="zbWorks.associateEditorUserIds"
										class="form-control table_infomation" type="text"></td>
								</tr>
					...
					<div class="modal-footer">
						...
						<input name="zbWorks.worksId" id="tableid" type="hidden" />
