									...
									<table class="tab" id="info_table">
										...
										<tbody id="baseinfo">
											<tr>
												<!-- name="zbInfo." -->
												<td>工号：</td>
												<td><input name="zbInfo.zbInfoId"
													type="hidden"> <input name="zbInfo.userId"
											...
											<tr>
												<td>证件类型：</td>
												<td><select name="zbInfo.certificateType"
												...
												<td>证件号码:</td>
												<td><input name="zbInfo.certificateNo"
													class="form-control table_infomation  card_num" type="text"></td>
												<td>民族：</td>
												<td><select name="zbInfo.nation"
													class="form-control table_infomation">
														<option>汉族</option>
														<option>少数民族</option>
												</select></td>
											...
											<tr>
												<td>国籍：</td>
												<td><select name="zbInfo.nationality"
													class="form-control table_infomation">
														<option>中国</option>
														<option>国外</option>
												</select></td>
												<td>港澳台：</td>
												<td><select name="zbInfo.GAT"
													class="form-control table_infomation">
														<option>否</option>
														<option>是</option>
												</select></td>
												<td>华侨：</td>
												<td><select name="zbInfo.huaQiao"
													class="form-control table_infomation">
														<option>否</option>
														<option>是</option>
												</select></td>
											...
											<tr>
												<td>政治面貌：</td>
												<td><select name="zbInfo.politicalStatus"
													class="form-control table_infomation">
														<option>共青团员</option>
														<option>共产党员</option>
														<option>民主党派</option>
											...
											<tr>
												...
												<td>最高学位：</td>
												<td><select name="zbInfo.highestDegree"
													class="form-control table_infomation">
														<option>博士</option>
														<option>硕士</option>
														<option>学士</option>
												...
												<td>学缘：</td>
												<td><select name="zbInfo.learnEdgeStructure"
													class="form-control table_infomation">
														<option>本校</option>
														<option>外校（境内）</option>
														<option>外校（境外）</option>
											...
											<tr>
												<td>专业技术职称：</td>
												<td><select name="zbInfo.professionalTitle"
													class="form-control table_infomation">
														<option>教授</option>
														<option>副教授</option>
														<option>讲师</option>
												...
												<td>职称级别：</td>
												<td><select name="zbInfo.professionalGrade"
													class="form-control table_infomation">
														<option>正高级</option>
														<option>副高级</option>
														<option>中级</option>
												...
												<td>学科类别：</td>
												<td><input name="zbInfo.subjectCategory"
													class="form-control table_infomation " type="text"></td>
											</tr>
											<tr>
												<td>参加工作时间：</td>
												<td><input name="zbInfo.workDate"
													class="form-control table_infomation laydate-icon "
													type="text"></td>
												<td>入校时间：</td>
												<td><input name="zbInfo.inductionDate"
													class="form-control table_infomation  laydate-icon"
													type="text"></td>
												<td>教师资格证号：</td>
												<td><input name="zbInfo.zbCertificateNo"
													class="form-control table_infomation" type="text"></td>
											</tr>
										</tbody>
										<tbody>
											...
											<tr>
												<td>授课类型：</td>
												<td><select name="zbInfo.teachingType"
													class="form-control table_infomation">
												...
												<td>授课状态：</td>
												<td><select name="zbInfo.teachingStatus"
													class="form-control table_infomation">
														<option>授课</option>
														<option>不授课进修</option>
														<option>不授课病休</option>
												...
												<td>任教专业名称：</td>
												<td><input name="zbInfo.teachingProfessionName"
													class="form-control table_infomation" type="text"
													placeholder="请输入任教专业名称"></td>
											</tr>
											<tr>
												<td>任教专业代码：</td>
												<td><input name="zbInfo.teachingProfessionNo"
													class="form-control table_infomation" type="text"
													placeholder="请输入任教专业代码"></td>
												<td>专业任教时间：</td>
												<td><input name="zbInfo.professionTeachingDate"
													class="form-control table_infomation " type="text"
													placeholder="请输入专业任教时间"></td>
												<td>是否实验技术人员：</td>
												<td><select
													name="zbInfo.experimentalTechnicalPersonnel"
													class="form-control table_infomation">
														<option>否</option>
														<option>是</option>
												</select></td>
											...
											<tr>
												<td>是否双师型：</td>
												<td><select name="zbInfo.doublezbType"
													class="form-control table_infomation">
														<option>否</option>
														<option>是</option>
												</select></td>
												<td>是否工程背景：</td>
												<td><select name="zbInfo.engineeringBackground"
													class="form-control table_infomation">
														<option>否</option>
														<option>是</option>
												</select></td>
												<td>是否行业背景：</td>
												<td><select name="zbInfo.industryBackground"
													class="form-control table_infomation">
														<option>否</option>
														<option>是</option>
												</select></td>
											...
											<tr>
												<td>行政职务级别：</td>
												<td><select name="zbInfo.administrativeRank"
													class="form-control table_infomation">
														<option>正厅级</option>
														<option>副厅级</option>
														<option>正处级</option>
												...
												<td>研究生导师类型：</td>
												<td><select name="zbInfo.graduateTutorType"
													class="form-control table_infomation">
														<option>否</option>
														<option>硕士生导师</option>
														<option>博士生导师</option>
												...
												<td>校内指导博士生人数：</td>
												<td><input name="zbInfo.numberOfDoctor"
													class="form-control table_infomation" type="text"
											...
											<tr>
												<td>校内指导硕士生人数：</td>
												<td><input name="zbInfo.numberOfMaster"
													class="form-control table_infomation" type="text"
													placeholder="请输入校内指导硕士生人数"></td>
												<td>职工类型：</td>
												<td><select name="zbInfo.employeeType"
													class="form-control table_infomation">
														<option>专任教师</option>
														<option>行政人员</option>
														<option>教辅人员</option>
												...
												<td>录用类型：</td>
												<td><select name="zbInfo.employmentType"
													class="form-control table_infomation">
														<option>在编</option>
														<option>聘任</option>
												</select></td>
											...
											<tr>
												<td>任职状态：</td>
												<td><select name="zbInfo.jobStatue"
													class="form-control table_infomation">
														<option>在职</option>
														<option>当年离职</option>
														<option>请假</option>
												...
												<td>异动类型：</td>
												<td><select name="zbInfo.transactionType"
													class="form-control table_infomation">
														<option>无</option>
														<option>录用毕业生</option>
												...
												<td>高校调入：</td>
												<td><select name="zbInfo.universityTransfer"
													class="form-control table_infomation">
														<option>否</option>
														<option>是</option>
												</select></td>
											...
											<tr>
												<td>本校毕业：</td>
												<td><select name="zbInfo.schoolGraduation"
													class="form-control table_infomation">
														<option>否</option>
														<option>是</option>
												</select></td>
												<td>本校调整：</td>
												<td><select name="zbInfo.schoolAdjustment"
													class="form-control table_infomation">
														<option>否</option>
														<option>是</option>
												</select></td>
												<td>校外教师类型：</td>
												<td><select name="zbInfo.offCampuszbType"
													class="form-control table_infomation">
														<option>否</option>
														<option>外籍教师</option>
