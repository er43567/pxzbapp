	...
	<div class="row">
		<div class="col-md-12">
			...
			<ul class="nav nav-tabs">
				<li class=""><a data-toggle="tab" href="#info">装备</a></li>
<!-- 				<li class=""><a data-toggle="tab" href="#award">奖励</a></li>
				<li class=""><a data-toggle="tab" href="#works">著作</a></li> -->
<!-- 				<li class=""><a data-toggle="tab" href="#paper">测试标签页</a></li> -->
							...
							<div class="box-tools m-b-15">
								<div style="width: 100%;" class="input-group">
									...
									<div style="width: 100%; margin-top: 6px;" class="collapse"
										...
										<div class="well">
											<div id="search">
												<label>根据条件搜索装备：</label> <select id="all_options"
													class="all_options form-control ">
													<option value="">请选择</option>
													<!-- <option value="userName">姓名</option> -->
													<option value="userId">装备ID</option>
													<option value="userName">装备名</option>
													<option value="jobStatue">所属名</option>
													<option value="highestDegree">所属分类</option>
													<option value="highestEducation">所属支队</option>
