...
/**
 * zbAward entity. @author MyEclipse Persistence Tools
 */
public class zbAward implements java.io.Serializable {
	...
	/** minimal constructor */
	public zbAward(String awardId) {
		this.awardId = awardId;
	}

	/** full constructor */
	public zbAward(String awardId, String userId, String achievementName, String awardName, String awardUserNames,
	...
	public String toString() {
		return "zbAward [awardId=" + awardId + ", userId=" + userId + ", achievementName=" + achievementName
