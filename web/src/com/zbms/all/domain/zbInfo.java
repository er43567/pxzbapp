...
/**
 * zbInfo entity. @author MyEclipse Persistence Tools
 */

public class zbInfo implements java.io.Serializable {

	// Fields

	private String zbInfoId;
	...
	private String zbCertificateNo;
	...
	private String offCampuszbType;
	...
	/** minimal constructor */
	public zbInfo(String zbInfoId) {
		this.zbInfoId = zbInfoId;
	}

	/** full constructor */
	public zbInfo(String zbInfoId, String userId, String certificateType, String certificateNo, String nation,
			...
			String zbCertificateNo, String teachingType, String teachingStatus, String teachingProfessionName,
			String teachingProfessionNo, String professionTeachingDate, String experimentalTechnicalPersonnel,
			String doublezbType, String engineeringBackground, String industryBackground,
			...
			String universityTransfer, String schoolGraduation, String schoolAdjustment, String offCampuszbType,
		...
		this.zbCertificateNo = zbCertificateNo;
		...
		this.doublezbType = doublezbType;
		...
		this.offCampuszbType = offCampuszbType;
	...
	public String getzbCertificateNo() {
		return this.zbCertificateNo;
	}

	public void setzbCertificateNo(String zbCertificateNo) {
		this.zbCertificateNo = zbCertificateNo;
	}
	...
	public String getDoublezbType() {
		return this.doublezbType;
	}

	public void setDoublezbType(String doublezbType) {
		this.doublezbType = doublezbType;
	}
	...
	public String getOffCampuszbType() {
		return this.offCampuszbType;
	}

	public void setOffCampuszbType(String offCampuszbType) {
		this.offCampuszbType = offCampuszbType;
	}
	...
	public String toString() {
		return "zbInfo [zbInfoId=" + zbInfoId + ", userId=" + userId + ", certificateType="
				...
				+ ", zbCertificateNo=" + zbCertificateNo + ", teachingType=" + teachingType
				...
				+ ", doublezbType=" + doublezbType + ", engineeringBackground=" + engineeringBackground
				...
				+ ", schoolAdjustment=" + schoolAdjustment + ", offCampuszbType=" + offCampuszbType
