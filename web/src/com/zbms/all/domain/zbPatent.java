...
/**
 * zbPatent entity. @author MyEclipse Persistence Tools
 */

public class zbPatent implements java.io.Serializable {
	...
	/** minimal constructor */
	public zbPatent(String patentId) {
		this.patentId = patentId;
	}

	/** full constructor */
	public zbPatent(String patentId, String userId, String patentName, String authorUserNames,
