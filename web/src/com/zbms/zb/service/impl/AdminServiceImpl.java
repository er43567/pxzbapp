...
import com.zbms.zb.dao.AdminDao;
...
public class AdminServiceImpl implements AdminService {
	...
	@Override
	public TableInfoAndUserVo getzbTableInfoById(String tableName, String tableId) {
	...
	@Override
	public String addzbInfo(zbInfo zbInfo, String departmentId) {
		zbInfo.setzbInfoId(uuid.getUuid());
		zbInfo.setDataStatus("10");
		zbInfo.setCreateTime(TimeUtil.getStringDay());
		adminDao.addInfo(zbInfo);

		User user = new User();
		user.setUserId(zbInfo.getUserId());// 用户id
